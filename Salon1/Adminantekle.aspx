<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Adminantekle.aspx.cs" Inherits="Salon1.Adminantekle" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 100%">
        ...
        <tr>
            <td style="width: 101px">Kademesi:</td>
            <td>&nbsp;</td>
            <td>
